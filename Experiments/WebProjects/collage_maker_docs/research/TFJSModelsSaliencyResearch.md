...
- `~/workspace/References/tfjs-models/README.md` — Model catalog
- `~/workspace/References/tfjs-models/coco-ssd/README.md` — Coco SSD docs
- `~/workspace/References/tfjs-models/coco-ssd/src/classes.ts` — 80 COCO classes
- `~/workspace/References/tfjs-models/coco-ssd/package.json` — Dependencies
- `~/workspace/References/tfjs-models/coco-ssd/demo/index.js` — Usage example
- `~/workspace/References/tfjs-models/deeplab/README.md` — DeepLab docs
- `~/workspace/References/tfjs-models/deeplab/src/config.ts` — PASCAL/Cityscapes/ADE20K labels
- `~/workspace/References/tfjs-models/deeplab/demo/src/index.js` — DeepLab usage example
- `~/workspace/References/tfjs-models/face-detection/README.md` — Face detection docs
- `~/workspace/References/tfjs-models/body-segmentation/README.md` — Body segmentation docs
- `~/workspace/References/tfjs-models/depth-estimation/README.md` — Depth estimation docs
- `~/workspace/References/tfjs-models/mobilenet/README.md` — MobileNet (for comparison)
