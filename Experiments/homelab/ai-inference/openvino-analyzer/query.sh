#!/usr/bin/env bash
# Query helper for OpenVINO Image Analyzer experiment
# Usage: podman exec homelab-openvino-analyzer-test /query.sh <command>
...
case "${1:-help}" in
    ...
    schema)
        ...
        ;;
    help|*)
        echo "OpenVINO Image Analyzer - Query Helper"
        echo ""
