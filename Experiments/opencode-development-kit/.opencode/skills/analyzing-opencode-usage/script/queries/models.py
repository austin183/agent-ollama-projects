#!/usr/bin/env python3
"""Model usage query for [ProjectName] LLM usage analytics.

Fetches model breakdown statistics. Uses read-only connections and parameterized queries.
"""
...
def fetch(
    ...
    Returns:
        List of ModelRow objects sorted by total tokens descending (limit 20).
    """
