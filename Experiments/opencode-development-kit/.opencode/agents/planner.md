...
3. **Consult Skills**: When planning work related to project-specific technologies or testing, consult the relevant project skills and their reference files. These documents capture verified behavior, patterns, and hard-won learnings for this project — don't rely on model assumptions alone.
