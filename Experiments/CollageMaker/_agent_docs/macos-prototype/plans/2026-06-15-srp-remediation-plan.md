...
| 4.6 | `LayoutConfigSidebar.swift` | 16 | `layoutManager.layoutStyle`, `gutter`, `diagonalSliceAngle`, `hexagonalSpacing`, `doubleExposureMaskOpacity`, `doubleExposureMaskImage` | ✅ DONE |
| 4.7 | `PanelCropEditor.swift` | 3 | `imageCoordinator.getEffectiveImageIndex`, `imageLibrary.images` | ✅ DONE |
| 4.8 | `CollageEditorView.swift` | 14 | `layoutManager.panels`, `imageLibrary.images`, `imageCoordinator.getEffectiveImageIndex/swapPanelImages/removeImage`, `cropManager.scrollPanActivePanelId` | ✅ DONE |
