...
# Implement
```
Please implement the plan for Phase 8 in @_agent_docs/plans/2026-06-15-srp-remediation-plan.md using our macos skills for guidance.
```
...
```
Please use the learnings in @_agent_docs/learnings/polygon-clip-y-axis-flip-visible-bounds.md to refine our macos skills using /skills-best-practice for guidance.
```
