...
```
Can you please help me think through how we can address the change request in @_agent_docs/change-requests/round-103.md using our macos skills for guidance?  You can get a second perspective by running @planner-g31 
```
...
# Implement
```
Please implement the plan for Phase 1 in @_agent_docs/plans/2026-06-20-round-103-saliency-diagnostics.md using our macos skills for guidance.
```
...
```
Please review our project to see if it meets Human Interface Guidelines as described in our hig references in /building-macos-apps and write your review to @_agent_docs/reviews 
```

# Documenting Sessions
```
Please update our project timeline in @_agent_docs/project-timeline/prototype-2-project-timeline.md with our latest session and add a detail session document in @_agent_docs/project-timeline/sessions .
```
...
```
Please use the learnings in @_agent_docs/learnings/visual-debug-overlay-coordinate-bugs.md to refine our macos skills using /skills-best-practice for guidance.
```
