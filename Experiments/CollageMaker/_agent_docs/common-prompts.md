...
```
Please use the learnings in @_agent_docs/learnings/uitest-bundle-resource-discovery.md to refine our macos skills using /skills-best-practice for guidance.
```
