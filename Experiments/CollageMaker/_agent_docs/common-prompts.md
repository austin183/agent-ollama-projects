...
```
Please use the learnings in @_agent_docs/learnings/cgblendmode-empty-context-learnings.md to refine our macos skills using /skills-best-practice for guidance.
```
