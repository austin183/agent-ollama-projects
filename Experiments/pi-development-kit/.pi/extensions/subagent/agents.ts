 ...
 * Source: @earendil-works/pi-coding-agent v0.84.2, examples/extensions/subagent/agents.ts
 * Re-sync: copy that file over this one, then restore this header.
 * Kit plan: _agent_docs/plans/2026-08-15-opencode-kit-port-to-pi.md (Phase 1)
 */
